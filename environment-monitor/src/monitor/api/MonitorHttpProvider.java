...
public class MonitorHttpProvider implements Provider<DataSource> {
	...
	private String mockPSOutput =
		...
		"echo devops    10917     1  0 Sep16 ?        00:05:57 /usr/java/jdk1.6.0_20/jre/bin/java -Xms393m -Xmx393m -XX:PermSize=32m -XX:MaxPermSize=64m -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintTenuringDistribution -XX:+UsePerfData -XX:+PrintGCApplicationConcurrentTime -XX:+PrintGCApplicationStoppedTime -server -Dlog4j.defaultInitOverride=true -Dtomcat.keystore.type=JKS -Dlog.lus.level=INFO -Dsun.net.inetaddr.negative.ttl=0 -Dlog.default.level=INFO -Dlog.cxf.level=INFO -Dcom.sun.management.jmxremote.authenticate=false -Dlog.dir=/var/log/carrero-scanner-service -Dtomcat.truststore.type=JKS -Dtomcat.truststore.password=howmanybets -Dlog.carrero.level=INFO -Dcom.sun.management.jmxremote.ssl=false -Djava.io.tmpdir=/var/app/carrero-scanner-service/tmp -Dcatalina.base=/var/app/carrero-scanner-service -Dlog.carrero.services.level=INFO -Dtomcat.http.port=8580 -Dtomcat.client.auth=true -Dlog.spring.level=INFO -Dconf.dir=/var/app/carrero-scanner-service/chef.env/conf -Dtomcat.truststore.file=/etc/carrero-truststores/carrero-truststore.jks -Dsun.net.inetaddr.ttl=600 -Dtomcat.keystore.password=howmanybets -Dlog.root.level=INFO -Dhostname=node365.test.carrero.es -Dcatalina.home=/var/app/carrero-scanner-service -Dlog.date.pattern=.yyyy-MM-dd-HH -Dtomcat.https.port=8543 -Dlog.quartz.level=INFO -Dcom.sun.management.jmxremote.port=8226 -Dtomcat.shutdown.port=8205 -Dtomcat.keystore.file=/etc/carrero-scanner-service/certs/scanner-service-server.jks -Dlog.apache.level=INFO -Dlog.httpclient.level=INFO -Dsun.net.client.defaultConnectTimeout=5000 -Dtomcat.maxThreads=150 -classpath /var/app/carrero-scanner-service/bootstrap/classes:/var/app/carrero-scanner-service/chef.env/conf:/var/app/carrero-scanner-service/common.env/conf:/var/app/carrero-scanner-servicelib/bootstrap.jar:/var/app/carrero-scanner-servicelib/tomcat-juli.jar org.apache.catalina.startup.Bootstrap start\n" +
