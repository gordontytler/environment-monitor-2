 ...
 * closes the tab.
 * 
 * Copied from : http://forums.sun.com/thread.jsp?thread=337070 24-Nov 2004
 * 
 */
@SuppressWarnings("serial")
public class CloseableTabbedPane extends JTabbedPane implements MouseListener, MouseMotionListener {

	static Logger logger = Logger.getLogger(CloseableTabbedPane.class.getName());	
	/**
	...
	private void processMouseEvents(MouseEvent e) {
		...
		if (icon != null) {
			...
			Rectangle drawRect = new Rectangle(rect.x - pos.x + vpDiffX, rect.y - pos.y + vpDiffY, rect.width,
					rect.height);
     ...
     * relative to its parent.
		...
		public Rectangle getBounds() {
			...
			return new Rectangle(x_pos - 1, y_pos - 1, width + 2, height + 2);
		}
	}
