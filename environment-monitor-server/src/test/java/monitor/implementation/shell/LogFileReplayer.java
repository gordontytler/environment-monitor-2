...
public class LogFileReplayer {
	...
	private String nowYYYYMMDD =  new SimpleDateFormat(YYYYMMDD).format(new Date());
	
	/**
	 * replay an existing file
	 * @param  timeDilation 0.5 would play back at double speed, 2 is half speed 
	 */
	public void replay(String outputFileName, String inputFileName, double timeDilation) throws FileNotFoundException, IOException, InterruptedException {
	...
	List<String> load(String inputFile) throws FileNotFoundException, IOException  {
		List<String> lines = new ArrayList<String>();
		File file = new File(inputFile);		
		BufferedReader reader = new BufferedReader(new FileReader(DataDirectory.getDataDirectory() + file));
