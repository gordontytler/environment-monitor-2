...
public class ActionOutputRunnable implements Runnable {
	...
	private final String fullPathToData = Configuration.getInstance().getFullPathToInstallDirectory() + "/" + DataDirectory.getDataDirectory();	
	...
	private EnvironmentViewBuilder environmentViewBuilder;
	private AlreadyRunningChecker alreadyRunningChecker = AlreadyRunningChecker.getInstance();
	private String environmentName;
	private EnvironmentViewRow environmentViewRow;
	private Session outputCollectingSession;
