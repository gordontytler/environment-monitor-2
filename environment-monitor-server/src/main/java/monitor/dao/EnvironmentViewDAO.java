...
public class EnvironmentViewDAO  {
	...
	private EnvironmentView load(String environmentName) {
		...
		try {
			String fileName = getPath() + getDir() + FileDAOHelper.toFileName(environmentName) + ".txt";
	...
	public synchronized void saveEnvironmentView(EnvironmentView environmentView) {
		...
		try {
			...
			File file = new File(getPath() + getDir() + FileDAOHelper.toFileName(environmentView.getEnvironmentName()) + ".txt");
	...
	private String getPath() {
		...
		return  System.getProperty("user.dir")  + "/target/test-classes/";
	}

	protected String getDir() {
		//return DataDirectory.getDataDirectory() + File.separatorChar + "environments" + File.separatorChar;
		return  "environments" + File.separatorChar;
	}
